      ...
      <div className="container-page">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          <div className="md:col-span-1">
            ...
            <p className="font-display text-base italic text-parchment/60 leading-relaxed">"Chalcha? Hoina, Majjale Chalcha."</p>
            <p className="text-xs text-parchment/40 mt-3 leading-relaxed">Nepal's trusted second-hand marketplace for clothes and books.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <Link to="/terms" className="text-sm hover:text-parchment transition-colors">Seller Guidelines</Link>
              <Link to="/sustainability" className="text-sm hover:text-parchment transition-colors">Sustainability</Link>
            </div>
          </div>
          <div>
            <p className="section-label text-parchment/40 mb-4">Company</p>
            <div className="flex flex-col gap-2.5">
              <Link to="/about" className="text-sm hover:text-parchment transition-colors">About FERI</Link>
              <Link to="/sustainability" className="text-sm hover:text-parchment transition-colors">Sustainability</Link>
              <Link to="/contact" className="text-sm hover:text-parchment transition-colors">Contact</Link>
              <Link to="/privacy" className="text-sm hover:text-parchment transition-colors">Privacy Policy</Link>
              <Link to="/terms" className="text-sm hover:text-parchment transition-colors">Terms & Conditions</Link>
            </div>
          </div>
        </div>
        <div className="border-t border-parchment/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-parchment/30">© 2025 FERI Marketplace. Made with care in Nepal.</p>
